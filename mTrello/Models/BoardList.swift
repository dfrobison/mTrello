...
extension BoardList: NSItemProviderWriting {
    static let typeIdentifier = "com.robisonsoftwaredevelopment.mTrello.BoardList"
    ...
    func addNewCardWithContent(_ context: String) {
        cards.append(Card(content: context, boardListId: id))
    }

        
    func addNewCard() -> UUID {
